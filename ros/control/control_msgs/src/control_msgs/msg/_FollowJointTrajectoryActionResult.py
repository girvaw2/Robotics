"""autogenerated by genmsg_py from FollowJointTrajectoryActionResult.msg. Do not edit."""
...
class FollowJointTrajectoryActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','control_msgs/FollowJointTrajectoryResult']
