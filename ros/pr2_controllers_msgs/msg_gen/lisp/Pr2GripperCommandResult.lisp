...
;//! \htmlinclude Pr2GripperCommandResult.msg.html

(cl:defclass <Pr2GripperCommandResult> (roslisp-msg-protocol:ros-message)
  ((position
    :reader position
    :initarg :position
    :type cl:float
...
(cl:defclass Pr2GripperCommandResult (<Pr2GripperCommandResult>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Pr2GripperCommandResult>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Pr2GripperCommandResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-msg:<Pr2GripperCommandResult> is deprecated: use pr2_controllers_msgs-msg:Pr2GripperCommandResult instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Pr2GripperCommandResult>))
...
(cl:defmethod effort-val ((m <Pr2GripperCommandResult>))
...
(cl:defmethod stalled-val ((m <Pr2GripperCommandResult>))
...
(cl:defmethod reached_goal-val ((m <Pr2GripperCommandResult>))
  ...
  (reached_goal m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Pr2GripperCommandResult>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Pr2GripperCommandResult>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Pr2GripperCommandResult>)))
  "Returns string type for a message object of type '<Pr2GripperCommandResult>"
  "pr2_controllers_msgs/Pr2GripperCommandResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Pr2GripperCommandResult)))
  "Returns string type for a message object of type 'Pr2GripperCommandResult"
  "pr2_controllers_msgs/Pr2GripperCommandResult")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pr2GripperCommandResult>)))
  "Returns md5sum for a message object of type '<Pr2GripperCommandResult>"
  "e4cbff56d3562bcf113da5a5adeef91f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pr2GripperCommandResult)))
  "Returns md5sum for a message object of type 'Pr2GripperCommandResult"
  "e4cbff56d3562bcf113da5a5adeef91f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pr2GripperCommandResult>)))
  "Returns full string definition for message of type '<Pr2GripperCommandResult>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pr2GripperCommandResult)))
  "Returns full string definition for message of type 'Pr2GripperCommandResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float64 position  # The current gripper gap size (in meters)~%float64 effort    # The current effort exerted (in Newtons)~%bool stalled      # True iff the gripper is exerting max effort and not moving~%bool reached_goal # True iff the gripper position has reached the commanded setpoint~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Pr2GripperCommandResult>))
  (cl:+ 0
     8
     8
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Pr2GripperCommandResult>))
  "Converts a ROS message object to a list"
  (cl:list 'Pr2GripperCommandResult
