/* Auto-generated by genmsg_cpp for file /home/billy/ros/stacks/pr2_controllers_msgs/msg/Pr2GripperCommandActionResult.msg */
...
struct Pr2GripperCommandActionResult_ {
  ...
  typedef  ::pr2_controllers_msgs::Pr2GripperCommandResult_<ContainerAllocator>  _result_type;
   ::pr2_controllers_msgs::Pr2GripperCommandResult_<ContainerAllocator>  result;


private:
  static const char* __s_getDataType_() { return "pr2_controllers_msgs/Pr2GripperCommandActionResult"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "143702cb2df0f163c5283cedc5efc6b6"; }
public:
...
}; // struct Pr2GripperCommandActionResult
...
{
template<class ContainerAllocator> struct IsMessage< ::pr2_controllers_msgs::Pr2GripperCommandActionResult_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::pr2_controllers_msgs::Pr2GripperCommandActionResult_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::pr2_controllers_msgs::Pr2GripperCommandActionResult_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::pr2_controllers_msgs::Pr2GripperCommandActionResult_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
