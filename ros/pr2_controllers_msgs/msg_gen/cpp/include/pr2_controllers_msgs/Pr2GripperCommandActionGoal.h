/* Auto-generated by genmsg_cpp for file /home/billy/ros/stacks/pr2_controllers_msgs/msg/Pr2GripperCommandActionGoal.msg */
...
struct Pr2GripperCommandActionGoal_ {
  ...
  typedef  ::pr2_controllers_msgs::Pr2GripperCommandGoal_<ContainerAllocator>  _goal_type;
   ::pr2_controllers_msgs::Pr2GripperCommandGoal_<ContainerAllocator>  goal;


private:
  static const char* __s_getDataType_() { return "pr2_controllers_msgs/Pr2GripperCommandActionGoal"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "aa581f648a35ed681db2ec0bf7a82bea"; }
public:
...
}; // struct Pr2GripperCommandActionGoal
...
{
template<class ContainerAllocator> struct IsMessage< ::pr2_controllers_msgs::Pr2GripperCommandActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::pr2_controllers_msgs::Pr2GripperCommandActionGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::pr2_controllers_msgs::Pr2GripperCommandActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::pr2_controllers_msgs::Pr2GripperCommandActionGoal_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
