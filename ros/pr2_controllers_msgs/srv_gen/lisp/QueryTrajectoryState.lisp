...
(cl:defmethod cl:initialize-instance :after ((m <QueryTrajectoryState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryTrajectoryState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-srv:<QueryTrajectoryState-request> is deprecated: use pr2_controllers_msgs-srv:QueryTrajectoryState-request instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <QueryTrajectoryState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:time-val is deprecated.  Use pr2_controllers_msgs-srv:time instead.")
  (time m))
...
(cl:defmethod cl:initialize-instance :after ((m <QueryTrajectoryState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryTrajectoryState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-srv:<QueryTrajectoryState-response> is deprecated: use pr2_controllers_msgs-srv:QueryTrajectoryState-response instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <QueryTrajectoryState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:name-val is deprecated.  Use pr2_controllers_msgs-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <QueryTrajectoryState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:position-val is deprecated.  Use pr2_controllers_msgs-srv:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <QueryTrajectoryState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:velocity-val is deprecated.  Use pr2_controllers_msgs-srv:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <QueryTrajectoryState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:acceleration-val is deprecated.  Use pr2_controllers_msgs-srv:acceleration instead.")
  (acceleration m))
