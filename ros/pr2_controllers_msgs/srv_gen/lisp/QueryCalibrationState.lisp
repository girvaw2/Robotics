...
(cl:in-package pr2_controllers_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <QueryCalibrationState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryCalibrationState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-srv:<QueryCalibrationState-request> is deprecated: use pr2_controllers_msgs-srv:QueryCalibrationState-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <QueryCalibrationState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryCalibrationState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_controllers_msgs-srv:<QueryCalibrationState-response> is deprecated: use pr2_controllers_msgs-srv:QueryCalibrationState-response instead.")))
...
(cl:defmethod is_calibrated-val ((m <QueryCalibrationState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_controllers_msgs-srv:is_calibrated-val is deprecated.  Use pr2_controllers_msgs-srv:is_calibrated instead.")
  (is_calibrated m))
