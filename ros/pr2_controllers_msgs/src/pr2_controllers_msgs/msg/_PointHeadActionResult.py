"""autogenerated by genmsg_py from PointHeadActionResult.msg. Do not edit."""
...
class PointHeadActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/PointHeadResult']
