"""autogenerated by genmsg_py from JointTrajectoryActionFeedback.msg. Do not edit."""
...
class JointTrajectoryActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/JointTrajectoryFeedback']
