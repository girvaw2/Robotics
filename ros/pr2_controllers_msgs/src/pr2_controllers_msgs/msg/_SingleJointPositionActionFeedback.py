"""autogenerated by genmsg_py from SingleJointPositionActionFeedback.msg. Do not edit."""
...
class SingleJointPositionActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/SingleJointPositionFeedback']
