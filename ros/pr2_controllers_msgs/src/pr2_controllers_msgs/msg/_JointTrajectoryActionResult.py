"""autogenerated by genmsg_py from JointTrajectoryActionResult.msg. Do not edit."""
...
class JointTrajectoryActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/JointTrajectoryResult']
