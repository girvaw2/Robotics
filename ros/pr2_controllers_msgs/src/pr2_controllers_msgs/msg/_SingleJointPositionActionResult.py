"""autogenerated by genmsg_py from SingleJointPositionActionResult.msg. Do not edit."""
...
class SingleJointPositionActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2_controllers_msgs/SingleJointPositionResult']
